        ...
        def copy_and_flip(split_images, target_dir):
            ...
            for img in split_images:
                ...
                with Image.open(img) as im:
                    ...
                    im_gray = ImageOps.equalize(im_gray)
                    # Zurück zu RGB konvertieren (falls das Modell 3 Kanäle erwartet)
                    im_gray_rgb = im_gray.convert("RGB")
                    # Speichern
                    im_gray_rgb.save(target_dir / class_dir.name / img.name)

                # Wenn Bild gespiegelt werden soll
                if img in flip_images:
                    with Image.open(img) as im:
                        ...
                        im_gray_rgb = im_gray.convert("RGB")
                        # Spiegeln
                        im_flipped = im_gray_rgb.transpose(Image.FLIP_LEFT_RIGHT)
...
print("\n✅ Split abgeschlossen. Alle Bilder wurden in Graustufen umgewandelt.")